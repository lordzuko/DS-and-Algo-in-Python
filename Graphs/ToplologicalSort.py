def topological_sort(g):
    ...
    ready = []                      # list of vertices that have no remaining constraint
    ...
    for u in g.vertices():
        ...
        if incount[u] == 0:                     # if u has no incoming edges,
            ready.append(u)                     # it is free of constraint

    while len(ready) > 0:
        u = ready.pop()                         # u is free of constraint
        topo.append(u)                          # add u to toplogical order
